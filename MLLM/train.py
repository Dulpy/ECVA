...
from MLLM.constants import NUM_FRAMES, IGNORE_INDEX, MMODAL_TOKEN_INDEX, DEFAULT_MMODAL_TOKEN, DEFAULT_MMODAL_START_TOKEN, DEFAULT_MMODAL_END_TOKEN
from MLLM.mm_utils import tokenizer_MMODAL_token, tokenizer_image_token, expand2square, process_video, process_image
from MLLM.videollama2_trainer import (
    VideoLLaMA2Trainer,
...
def train(attn_implementation=None):
    ...
    if training_args.lora_enable:
        ...
        safe_save_model_for_hf_trainer(trainer=trainer, output_dir=training_args.output_dir)
    # trainer.save(output_dir=training_args.output_dir)
