...
from .mamba_arch import *

class AnomShieldMetaModel:

    def __init__(self, config):
        super(AnomShieldMetaModel, self).__init__(config)
...
class AnomShieldMetaForCausalLM(ABC):
    ...
    def temporal_aggregator(self, frames_features):
        ...
        # *********** mean pooling *************
        if self.config.mm_projector_type == "mamba_scan":
